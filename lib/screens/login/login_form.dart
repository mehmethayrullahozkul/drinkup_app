...
class _LoginFormState extends State<LoginForm> {
  ...
  final GlobalKey<FormState> _k1 = GlobalKey<FormState>();
  final GlobalKey<FormState> _k2 = GlobalKey<FormState>();
...
//
  ...
  */
  ...
  Widget build(BuildContext context) {
    print("currently login page");
    onLoginButtonPressed() async {
      BlocProvider.of<LoginBloc>(context).add(LoginButtonPressed(
          username: /* _usernameField.text */ "Hayrullah",
          password: _passwordField.text));
    }

    onAnonymousLoginButtonPressed() async {
      BlocProvider.of<LoginBloc>(context)
          .add(AnonymousLoginButtonPressed(username: _usernameField.text));
    }
